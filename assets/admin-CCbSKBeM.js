var M=Object.defineProperty;var x=(t,e,i)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var w=(t,e,i)=>x(t,typeof e!="symbol"?e+"":e,i);import{s as g,A as n,u as $,e as l,c as u,t as A}from"./utils-DC_m5SDi.js";const m=class m{static async uploadProductImage(e,i){const d=e.name.split(".").pop()||"jpg",c=`products/${i}/cover.${d}`,{error:v}=await g.storage.from(m.PRODUCT_BUCKET).upload(c,e,{upsert:!0,contentType:e.type||"image/jpeg",cacheControl:"3600"});if(v)throw v;const{data:p}=g.storage.from(m.PRODUCT_BUCKET).getPublicUrl(c);return p.publicUrl}};w(m,"PRODUCT_BUCKET","product-images");let b=m;const s={products:[],schools:[],paymentMethods:[],orders:[],config:{loja:"Imagine Art",whatsapp:"",mensagem:"Olá! Gostaria de fazer este pedido:",moeda:"BRL",banner:""},currentFile:null,editingProductId:null,editingSchoolId:null,editingPaymentMethodId:null},N=document.querySelector("#app"),a=t=>document.getElementById(t);function P(){N.innerHTML=`
    <div class="topbar">
